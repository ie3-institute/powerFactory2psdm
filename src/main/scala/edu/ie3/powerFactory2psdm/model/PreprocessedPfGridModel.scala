...
/**
  ...
  * The preprocessing is done in order to unpack and check Optionals of the [[RawPfGridModel]], check for duplicated ids
  * as well as allow for building inheritance relationships of all the custom classes of grid elements (e.g. nodes, lines, generators)
  * since these can not sensibly be actualized by the [[SchemaGenerator]].
  *
  * @param nodes electrical nodes of the grid
  * @param lineTypes line types of the grid
  * @param lines electrical lines of the grid
  * @param switches electrical switches of the grid
  * @param transformerTypes2W two-winding transformer types
  * @param conversionPrefixes conversion prefixes for certain model parameters
  */
...
object PreprocessedPfGridModel extends LazyLogging {
  ...
  /**
    * Builds the preprocessed grid model from the unprocessed generated grid model.
    *
    * @param rawGrid the raw PowerFactory grid model as generated by the [[SchemaGenerator]]
    * @return the preprocessed PowerFactory grid model
    */
