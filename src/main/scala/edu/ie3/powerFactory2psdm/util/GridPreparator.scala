...
object GridPreparator extends LazyLogging {
  ...
  /**
    * Perform preparation of the [[RawPfGridModel]] before the actual conversion can happen.
    *
    * @param pfGrid the [[RawPfGridModel]] to prepare
    * @return the prepared [[RawPfGridModel]]
    */
  ...
  /**
    * Removes [[Switches]] from a [[RawPfGridModel]] that are only connected to a single node.
    *
    * @param maybeSwitches
    * @return
    */
